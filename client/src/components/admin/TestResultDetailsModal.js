...
import { ExclamationTriangleIcon, CheckCircleIcon, SparklesIcon, QuestionMarkCircleIcon } from './AdminIcons';

const API_URL = process.env.REACT_APP_API_URL || "http://localhost:8080";

export const TestResultDetailsModal = ({ resultId, onClose, onUpdate, beigeTextColor }) => {
