...
const ProgressAnalysis = ({ summaryData }) => {
    ...
    return (
        <div className="space-y-6 sm:space-y-8 animate-fade-in pb-12">
            ...
            {studentsProgress.length === 0 && (
                <div className="p-12 text-center bg-[#0f172a]/40 backdrop-blur-sm rounded-[2rem] border border-dashed border-white/10 shadow-inner mx-auto max-w-md">
                    ...
                    <p className="text-slate-500 font-medium text-sm">Zatiaľ žiadni študenti na analýzu.</p>
                </div>
            )}
        </div>
    );
